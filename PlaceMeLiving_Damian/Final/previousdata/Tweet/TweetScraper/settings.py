...
SAVE_TWEET_PATH = './Users/uu/TweetScraper/data/bungalow.com'
SAVE_USER_PATH = './Users/uu/TweetScraper/data/bungalow.com'
...
MYSQL_USER   = "yatingyang01@gmail.com"        # MySQL user to use (should have INSERT access granted to the Database/Table
MYSQL_PWD    = "Yt199785"        # MySQL user's password
